...
/**
  ...
  */
class OwmCacheClient(val cacheSize: Int,
  ...
  def receive[W <: OwmResponse: Manifest](
      request: OwmRequest): WeatherError \/ W =
    await(request)
  ...
  /**
    ...
    */
  def getCachedOrRequest(latitude: Float,
                         longitude: Float,
                         timestamp: Int): WeatherError \/ Weather = {
  ...
  def getCachedOrRequest(latitude: Float,
                         longitude: Float,
                         timestamp: DateTime): WeatherError \/ Weather = {
  ...
  /**
    ...
    */
  private def await[W <: OwmResponse: Manifest](
      request: OwmRequest): WeatherError \/ W =
    try {
      ...
      case e: java.util.concurrent.TimeoutException =>
        \/.left(TimeoutError(
          s"OpenWeatherMap Error: server didn't responded in $timeout seconds. Timeout"))
    }
}
...
object OwmCacheClient {
  ...
  def apply(appId: String,
    ...
    new OwmCacheClient(cacheSize,
                       geoPrecision,
                       OwmAsyncClient(appId, AkkaHttpTransport(host)),
                       timeout)
  ...
  def apply(appId: String,
    ...
    new OwmCacheClient(cacheSize,
                       geoPrecision,
                       OwmAsyncClient(appId, transport),
                       timeout)
}
