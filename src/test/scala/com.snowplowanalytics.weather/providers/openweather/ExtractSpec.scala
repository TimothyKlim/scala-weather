...
class ExtractSpec extends Specification with DisjunctionMatchers {
  def is = s2"""
  ...
  def e1 = {
    val json = parseJson(
      Source.fromURL(getClass.getResource("/history.json")).mkString)
  ...
  def e2 = {
    val json = parseJson(
      Source.fromURL(getClass.getResource("/history-empty.json")).mkString)
    val weather = dummyClient.extractWeather[History](json)
  ...
  def e3 = {
    val json = parseJson(
      Source.fromURL(getClass.getResource("/current.json")).mkString)
  ...
  def e4 = {
    val json = parseJson(
      Source.fromURL(getClass.getResource("/forecast.json")).mkString)
  ...
  def e5 = {
    val json = parseJson(
      Source.fromURL(getClass.getResource("/empty.json")).mkString)
    val weather = dummyClient.extractWeather[History](json)
  ...
  def e6 = {
    val json = parseJson(
      Source.fromURL(getClass.getResource("/nodata.json")).mkString)
    val weather = dummyClient.extractWeather[History](json)
